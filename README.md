...
| string-heavy (\uXXXX escapes) | 1.0x | 0.9x | 1.1x | 1.1x |
...
pure-ASCII strings read **~2.4x**, write **~4.1x**; raw UTF-8 string-heavy
read **+26%**. Short-string and mixed-unicode payloads see no benefit (a
